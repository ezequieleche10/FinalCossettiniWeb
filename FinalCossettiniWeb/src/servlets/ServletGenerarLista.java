...
/**
 * Servlet implementation class ServletGenerarLista
 */
@WebServlet("/ServletGenerarLista")
public class ServletGenerarLista extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletGenerarLista() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ex= gson.fromJson(request.getParameter("examen"), Examen.class);

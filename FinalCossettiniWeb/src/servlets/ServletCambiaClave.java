...
/**
 * Servlet implementation class ServletCambiaClave
 */
@WebServlet("/ServletCambiaClave")
public class ServletCambiaClave extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletCambiaClave() {
        super();
